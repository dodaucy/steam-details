...
function addGame(game, resultItem) {
    ...
    if (!game.modules.steam_core.success) {  // This should never happen
        throw new Error(`Steam error: ${game.modules.steam_core.error}`);
    }
    ...
    anchorWithImages.href = game.modules.steam_core.data.external_url;
    anchorWithImages.target = "_blank";
    anchorWithImages.className = "images";

    Array.from(game.modules.steam_core.data.images).forEach((image_url) => {
    ...
    titleAnchor.href = game.modules.steam_core.data.external_url;
    titleAnchor.target = "_blank";
    titleAnchor.className = "title";
    titleAnchor.textContent = game.modules.steam_core.data.name
